...
public class MathProblem {
	...
	//isCorrect 필드 대신에 ans 필드 추가해서 사용자가 입력한 답 저장할수 도 있습니다.
	...
	/*
	 * 참고 
	 * static 메소드는 인스턴스 필드값과 무관하게 동작하는 메소드 ( 객체와 연관된 동작이 아니다.)하게 동작하는 메소드
	...
	public void makeProb() { // 사칙연산 종류별로 적절한 난수 생성하기->문제를 만들어 줍니다.
		...
		case '*':
			...
			break;
		case '/':
			max1=99;max2=29;min1=41;min2=11;	//n1은 41~99, n2는 11~29	: n1>n2 나눗셈과정을 고려 n1을 좀더 크게
			break;

		}
		n1=r.nextInt(max1-min1+1)+min1;	//난수범위min1~max1
